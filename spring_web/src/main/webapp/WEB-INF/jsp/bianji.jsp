...
<head>
    ...
    <script>
        ...
        $(function () {
            $("#btn").click(function () {
                $.post("doedittop", {"tid": $("#tid").val(), "tname": $("#tname").val()}, function (data) {
                    $("#msg").fadeIn(1000);
                    if (data == 1) {
...
<table style="width: 60%;" align="center" class="table table-bordered">
        ...
        <td>
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input class="form-control" type="text" name="tname" id="tname" placeholder="主题名称" value="${topic.tname}">
                </div>
            </div>
        </td>
    </tr>
    <tr>
        <td align="right">
            <button type="button" id="btn" class="btn btn-success">编辑主题</button>
        </td>
